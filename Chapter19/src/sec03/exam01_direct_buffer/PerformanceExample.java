...
public class PerformanceExample {
    ...
    public static void main(String[] args) throws Exception {
        Path from = Paths.get("F:/Temp/house.jpg");
        Path to1 = Paths.get("F:/Temp/house2.jpg");
        Path to2 = Paths.get("F:/Temp/house3.jpg");
        ...
        System.out.println("넌 다이렉트 버퍼:\t" + (end-start) + " ns");
        ...
        System.out.println("다이렉트 버퍼:\t" + (end-start) + " ns");
